...
2. Con ```Knit```, genere el archivo _index.html_.
3. En su cuenta de GitHub, cree un repositorio llamado _tablero-control-mammalia-gam_.
4. Suba los archivos _index.Rmd_ e _index.html_ al nuevo repositorio.
5. Active la opción _GitHub Pages_ en su nuevo repositorio, para así poder visualizar el tablero de control resultante.
6. Clone el nuevo repositorio a su computadora y edítelo con RStudio, agregando el siguente contenido:
```
```
7. Continúe editando el archivo .Rmd y, cuando lo considere necesario, sincronice el repositorio local con el de su cuenta en GitHub.
